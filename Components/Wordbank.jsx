...
function Wordbank() {
    ...
    const words = [
        ...
        "Eager", "Faux", "Gloat", "Havoc", "Ideal", "Juicy", "Knave", "Leery", "Maxim", "Noisy",
    ...
    const definitions = [
        ...
        "an activity involving skill in making things by hand", "curious or unusual in a way that provokes dry amusement", "strongly wanting to do or have something", "made in imitation",
